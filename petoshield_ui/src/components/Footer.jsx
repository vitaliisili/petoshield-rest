                ...
                <div className='flex flex-col mt-7 md:mt-0 '>
                    ...
                    <div className='mt-7'>
                        ...
                        <div className='mt-5 flex justify-start space-x-4 md:space-x-0 md:justify-between text-2xl text-gallery'>
                            <Link to=''><FaFacebookF className='hover:text-rose cursor-pointer transition-all duration-300'/></Link>
                            <Link to=''><FaTwitter className='hover:text-rose cursor-pointer transition-all duration-300'/></Link>
                            <Link to=''><FaYoutube className='hover:text-rose cursor-pointer transition-all duration-300'/></Link>
                            <Link to=''><FaInstagram className='hover:text-rose cursor-pointer transition-all duration-300'/></Link>
                        </div>
                    </div>
