...
class TestJobTicketEndpoints:
    ...
    @pytest.mark.parametrize('position, first_name, last_name, email', [
        ...
        ('position', 'first', 'last', 'a"b(c)d,e:f;g<h>i[jk]l@example.com'),
...
class TestPartnerTicketEndpoints:
    ...
    @pytest.mark.parametrize('name, business_name, message, email, url', [
        ...
        ('name', 'business', 'message', 'a"b(c)d,e:f;g<h>i[jk]l@example.com', 'https://example.com'),
        ('name', 'business', 'message', 'ust"not"right@example.com', 'https://example.com'),
        ('name', 'business', 'message', 'his is"notallowed@example.com', 'https://example.com'),
        ('name', 'business', 'message', 'his stillnotallowed@example.com', 'https://example.com'),
